...
Docker sandboxing runs your AI coding agents (Claude Code, Codex CLI, OpenCode, Mistral Vibe, Cursor CLI, Copilot CLI, Pi) inside isolated Docker containers while maintaining access to your project files and credentials.
