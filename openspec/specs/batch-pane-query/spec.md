# Capability Spec: Batch Pane Query

**Capability**: `batch-pane-query`
**Created**: 2026-03-24
**Status**: Draft

## Purpose

Replace per-instance tmux subprocess calls with a single `tmux list-panes -a` batch query at the start of each poll cycle. This dramatically reduces the number of tmux subprocesses spawned, especially when many sessions are active.
