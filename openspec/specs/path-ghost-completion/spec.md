# Capability Spec: Path Ghost Completion

**Capability**: `path-ghost-completion`
**Created**: 2026-03-26
**Status**: Draft

## Purpose

Provide a reusable filesystem directory completion component that displays ghost text suggestions based on the current input path. Used by dialogs with path input fields (NewSessionDialog, GroupRenameDialog).
