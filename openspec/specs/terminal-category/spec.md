# Capability Spec: Terminal Category
...
The terminal category allows users to launch plain shell sessions (non-agent) through the same
session management interface used for AI coding agents. Terminal sessions use the user's default
