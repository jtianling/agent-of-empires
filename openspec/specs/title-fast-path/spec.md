# Capability Spec: Title Fast-Path

**Capability**: `title-fast-path`
**Created**: 2026-03-24
**Status**: Draft

## Purpose

Provide a zero-cost fast path for detecting Running status by checking the tmux pane title for Braille spinner characters. This avoids the expense of `capture-pane` when the agent's spinner is visible in the title.
